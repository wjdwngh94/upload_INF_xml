...
<!-- no로 전체 정보를 다 가져올 수 있어야 한다. -->
<%
	//delete의 변환과정을 사용한다. (받아올땐 언제나 String임으로)
...
<body>
	<div align="center">
		<form name="f" action="memberEdit_ok.jsp" method="post">
			<!-- hidden으로 필요한 데이터를 첨부한다. -->
			<!-- 사용자의 의지와 상관없이 no의 값을 첨부해 날린다. -->
			...
			<table width="500" class="outline">
				...
				<tr>
					...
					<td class="m3"><input type="text" id="sample6_postcode"
						name="post" placeholder="우편번호" maxlength="6" size="6" class="box"
						readonly onclick="sample6_execDaumPostcode()"
						value=<%=info.getPost()%>> <!-- disabled도 잠금 기능 수행 : 전송 안됨 -->
						<input type="button" value="우편번호 찾기"
						onclick="sample6_execDaumPostcode()"></td>
					<!-- null이 뜰 수 있으므로 getter method를 고친다. -->
				</tr>
				<tr>
				...
				<tr>
					<td class="m3"><input type="text" id="sample6_address2"
						placeholder="상세주소" name="addr2" class="box" maxlength="50"
						size="40" value=<%=info.getAddr2()%>></td>
				</tr>
				<tr>
					<th class="m2" colspan="2"><input type="button" value="수정"
